  ...
  args: {
    ...
    children: (
      <View className="flex-1 items-center justify-center gap-2 p-4">
        <Text className="text-z-text text-lg font-semibold">Screen content</Text>
        <Text className="text-z-muted">Safe-area insets are applied around this area.</Text>
      </View>
    ),
  },
  argTypes: {
    ...
    <View className="gap-3">
      {([
        ...
        <ZScreen key={edges.join('-') || 'none'} edges={edges} className="rounded-md border border-z-border">
          <View className="items-center justify-center gap-2 p-4">
            <Text className="text-z-text font-semibold">edges: [{edges.join(', ')}]</Text>
      ...
      <ZScreen className="rounded-md border border-z-border">
        <View className="items-center justify-center p-4">
          <Text className="text-z-muted text-center">
