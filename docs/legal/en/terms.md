...
1.1 These Terms of Use apply to the use of the digital video coaching platform **Strido** (hereinafter "Strido" or the "Service") at https://{{DOMAIN}} and in the associated apps.

1.2 The provider and contracting party is {{GBR_BEZEICHNUNG}}, {{ANSCHRIFT}}, email {{EMAIL}} (hereinafter "Provider" or "we"). The complete mandatory details can be found in the [Legal Notice](/imprint).
...
10.1 Any person may report allegedly illegal content to us. The report can be made via the [contact form](/contact) or by email to {{EMAIL}} and should contain:
...
10.3 Point of contact for users under Art. 12 DSA: {{EMAIL}}. Communication is possible in German and English. The point of contact for authorities under Art. 11 DSA is set out in the [Legal Notice](/imprint).
