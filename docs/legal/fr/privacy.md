...
Les responsables du traitement au sens du Règlement général sur la protection des données (RGPD) sont les deux associés de {{GBR_BEZEICHNUNG}} en qualité de **responsables conjoints du traitement** (article 26 du RGPD) :
...
- **article 6, par. 1, point a), du RGPD** – le consentement ;
- **article 6, par. 1, point b), du RGPD** – l'exécution du contrat d'utilisation ou des mesures précontractuelles ;
- **article 6, par. 1, point f), du RGPD** – l'intérêt légitime, en particulier à un fonctionnement sûr et stable.
...
Fournisseur : Google Cloud EMEA Limited (Irlande) ou Google LLC (États-Unis). Concernant les transferts vers des pays tiers, voir le point 12.
...
Fournisseur : WorkOS, Inc., États-Unis. Concernant les transferts vers des pays tiers, voir le point 12.
...
Fournisseur : Mux, Inc., États-Unis. Concernant les transferts vers des pays tiers, voir le point 12.
...
Fournisseur : Agora Lab, Inc., États-Unis. Concernant les transferts vers des pays tiers, voir le point 12.

## 7. Envoi d'e-mails (Resend)

Pour l'envoi d'e-mails liés au service (par exemple notifications, e-mails de réservation et de rendez-vous, et réponses aux demandes de contact), nous utilisons le prestataire d'envoi Resend. Sont traités votre adresse e-mail ainsi que le contenu et les métadonnées du message concerné (article 6, par. 1, points b) et f), du RGPD).

Fournisseur : Resend (Plus Five Five, Inc.), États-Unis. Concernant les transferts vers des pays tiers, voir le point 12.
...
Fournisseur : OpenRouter, LLC, États-Unis, ainsi que les fournisseurs de modèles respectivement intégrés. Concernant les transferts vers des pays tiers, voir le point 12.
...
Fournisseur : Expo (650 Industries, Inc.), États-Unis. Concernant les transferts vers des pays tiers, voir le point 12.
...
- à la portabilité des données (article 20 du RGPD), ainsi que
- d'**opposition** au traitement (article 21 du RGPD).
...
Vous avez le droit d'introduire une réclamation auprès d'une autorité de contrôle de la protection des données (article 77 du RGPD), en particulier auprès de l'autorité compétente à notre égard : {{AUFSICHTSBEHOERDE}}.
