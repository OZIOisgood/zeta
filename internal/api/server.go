...
func (s *Server) routes() {
	...
	s.Router.Group(func(r chi.Router) {
		...
		// Mobile OAuth flow — code exchange and token refresh (no cookies)
		r.Get("/auth/mobile/auth-url", authHandler.MobileAuthURL)
		r.Post("/auth/mobile/exchange", authHandler.MobileExchange)
		r.Post("/auth/mobile/refresh", authHandler.MobileRefresh)
