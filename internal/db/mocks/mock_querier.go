...
func (m *MockQuerier) CheckUsernameAvailable(ctx context.Context, arg db.CheckUsernameAvailableParams) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckUsernameAvailable", ctx, arg)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockQuerierMockRecorder) CheckUsernameAvailable(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckUsernameAvailable", reflect.TypeOf((*MockQuerier)(nil).CheckUsernameAvailable), ctx, arg)
}
...
// GetUserPreferencesByUsername mocks base method.
func (m *MockQuerier) GetUserPreferencesByUsername(ctx context.Context, lower string) (db.UserPreference, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserPreferencesByUsername", ctx, lower)
	ret0, _ := ret[0].(db.UserPreference)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUserPreferencesByUsername indicates an expected call of GetUserPreferencesByUsername.
func (mr *MockQuerierMockRecorder) GetUserPreferencesByUsername(ctx, lower any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserPreferencesByUsername", reflect.TypeOf((*MockQuerier)(nil).GetUserPreferencesByUsername), ctx, lower)
}
