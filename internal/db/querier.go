...
type Querier interface {
	...
	CountAdminActivity(ctx context.Context, arg CountAdminActivityParams) (int64, error)
	CountAdminSessions(ctx context.Context, arg CountAdminSessionsParams) (int64, error)
	CountAdminUsers(ctx context.Context, arg CountAdminUsersParams) (int64, error)
	CountAdminVideos(ctx context.Context, arg CountAdminVideosParams) (int64, error)
	...
	ListAdminActivity(ctx context.Context, arg ListAdminActivityParams) ([]ListAdminActivityRow, error)
	ListAdminGroupOptions(ctx context.Context, arg ListAdminGroupOptionsParams) ([]ListAdminGroupOptionsRow, error)
	ListAdminSessions(ctx context.Context, arg ListAdminSessionsParams) ([]ListAdminSessionsRow, error)
	ListAdminUserOptions(ctx context.Context, arg ListAdminUserOptionsParams) ([]ListAdminUserOptionsRow, error)
	ListAdminUsers(ctx context.Context, arg ListAdminUsersParams) ([]ListAdminUsersRow, error)
	ListAdminVideos(ctx context.Context, arg ListAdminVideosParams) ([]ListAdminVideosRow, error)
