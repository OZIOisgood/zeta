...
The controllers within the meaning of the General Data Protection Regulation (GDPR) are the two partners of {{GBR_BEZEICHNUNG}} as **joint controllers** (Art. 26 GDPR):
...
You have the right to lodge a complaint with a data protection supervisory authority (Art. 77 GDPR), in particular with the authority responsible for us: {{AUFSICHTSBEHOERDE}}.
