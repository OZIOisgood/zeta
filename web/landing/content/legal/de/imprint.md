...
Eine Umsatzsteuer-Identifikationsnummer nach § 27a Umsatzsteuergesetz ist nicht vorhanden. {{GBR_BEZEICHNUNG}} ist nicht im Handelsregister eingetragen.

## Kontaktstelle nach Art. 11 der Verordnung (EU) 2022/2065 (Digital Services Act – DSA)

Zentrale Kontaktstelle für Behörden und Gerichte: {{EMAIL_DSA}}
Die Kommunikation ist in deutscher und englischer Sprache möglich.

Die Kontaktstelle für Nutzerinnen und Nutzer nach Art. 12 DSA ist in unseren [Nutzungsbedingungen](/nutzungsbedingungen) geregelt.
