...
1.1 Les présentes Conditions d'utilisation s'appliquent à l'utilisation de la plateforme numérique de coaching vidéo **Strido** (ci-après « Strido » ou le « Service ») à l'adresse https://{{DOMAIN}} ainsi que dans les applications associées.

1.2 Le fournisseur et cocontractant est {{GBR_BEZEICHNUNG}}, {{ANSCHRIFT}}, e-mail {{EMAIL}} (ci-après le « Fournisseur » ou « nous »). Les mentions obligatoires complètes figurent dans les [Mentions légales](/mentions-legales).
...
10.1 Toute personne peut nous signaler des contenus présumés illicites. Le signalement peut être effectué via le [formulaire de contact](/contact) ou par e-mail à {{EMAIL}} et devrait contenir :
...
10.3 Point de contact pour les utilisateurs au titre de l'article 12 du DSA : {{EMAIL}}. La communication est possible en allemand et en anglais. Le point de contact pour les autorités au titre de l'article 11 du DSA figure dans les [Mentions légales](/mentions-legales).
