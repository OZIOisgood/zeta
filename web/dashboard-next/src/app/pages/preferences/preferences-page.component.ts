...
@Component({
  ...
  template: `
    <div class="grid gap-6">
      <section
        class="rounded-lg border border-[var(--z-border)] bg-white p-5 shadow-sm"
      >
        <div>
        ...
        @if (activeTab() === 'personal-data') {
          ...
          >
            <div class="flex items-start gap-3 border-b border-[var(--z-border)] pb-4">
              ...
              <div>
                <h2 class="text-base font-semibold">{{ 'preferences.personalData' | transloco }}</h2>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
              <label class="grid gap-2">
                <span class="text-sm font-semibold">{{ 'preferences.firstName' | transloco }}</span>
                <z-text-input
              ...
              <label class="grid gap-2">
                <span class="text-sm font-semibold">{{ 'preferences.lastName' | transloco }}</span>
                <z-text-input
              ...
              <label class="grid gap-2">
                <span class="text-sm font-semibold">{{ 'common.fields.language' | transloco }}</span>
                <z-select
              ...
              <label class="grid gap-2">
                <span class="text-sm font-semibold">{{ 'common.fields.timezone' | transloco }}</span>
                <z-combobox
                  ...
                  [placeholder]="'preferences.searchTimezones' | transloco"
          ...
          >
            ...
            <div class="rounded-md border border-[var(--z-border)] bg-[var(--z-surface-warm)] p-4">
...
export class PreferencesPageComponent {
  ...
  protected saveDisabled(): boolean {
    return (
      this.form.invalid ||
      this.form.pristine ||
      this.session.mutationStatus() === 'loading'
    );
  }
